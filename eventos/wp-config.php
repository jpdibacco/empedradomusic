...
$sDestDir = '/home/c0430417/public_html/eventos';
if ( substr($sDestDir, 0, 1) == "\\" ) {
      $sDestDir = "\\".$sDestDir ;
}
define( 'WPCACHEHOME', '/home/c0430417/public_html/eventos/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager

/** El nombre de tu base de datos de WordPress */
define('DB_NAME', 'c0430417_eventos');

/** Tu nombre de usuario de MySQL */
define('DB_USER', 'c0430417_eventos');

/** Tu contraseña de MySQL */
define('DB_PASSWORD', 'poidiwygybx3Tec');
