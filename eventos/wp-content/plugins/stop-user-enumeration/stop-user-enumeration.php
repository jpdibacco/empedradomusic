...
class Stop_User_Enumeration_Plugin {
  ...
  /**
    ...
    $this->donate_link = sprintf('<a target="_blank" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=4EMTVFMKXRRYY"><strong>%s</strong></a>',__("Donate to support free version"));
		$this->gopro_link = sprintf('<a target="_blank" href="http://fullworks.net/wp-security/register"><strong>%s</strong></a>',__("Go Pro - with Fullworks WP Security"));
...
<div class="notice notice-warning">
    <p>
      <?php
     printf(__('Plugin: Stop User Enueration now has settings, go to the %1$s page and save the new settings','stop-user-enumeration'),$this->settings_link);
     ?>
   </p>
</div>
<?php
