...
/*
  ...
  Version: 1.108
  Author: donweb.com
  Author URI: http://www.donweb.com
...
function agregar_menues() {
    ...
    add_submenu_page('envialo-simple', 'Campañas', 'Campañas', 'add_users', 'envialo-simple', '');
    add_submenu_page('envialo-simple', __('Crear Campaña', 'envialo-simple'), __('Crear Campaña', 'envialo-simple'), 'add_users', 'envialo-simple-nuevo', 'mostrarCrearNews');
