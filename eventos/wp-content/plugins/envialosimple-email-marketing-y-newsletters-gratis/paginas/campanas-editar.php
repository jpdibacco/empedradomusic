...
if (isset($_GET["idCampana"])) {
    ...
    $c["Name"] = isset($_POST["CampaignName"]) ? $_POST["CampaignName"] : "Campaña " . date("d-m-Y H:i");
                                            ...
                                            <div id="acciones" class="postbox ">
                                                        ...
                                                        <div id="minor-publishing" style="border:0">
                                                            ...
                                                            <div id="misc-publishing-actions">
                                                                <div class="misc-pub-section">
                                                                    <label for="post_status"><?php _e('Estado de la campaña:', 'envialo-simple') ?></label>
                                                                    <?php
                                                                    $estado = "";
                                                                    $enviada = FALSE;
                                                                    if ($c["Status"] == "Draft") {
                                                                        $estado = __('Borrador', 'envialo-simple');
                                                                        $accion = __('Enviar Campaña!', 'envialo-simple');
                                                                    } else if ($c["Status"] == "Active") {
                                                                        $estado = __('Activo', 'envialo-simple');
                                                                    } else if ($c["Status"] == "Completed") {
                                                                        $estado = __('Enviado', 'envialo-simple');
                                                                        $enviada = TRUE;
                                                                    } else if ($c["Status"] == "Paused") {
                                                                        $accion = __('Reanudar Envío!', 'envialo-simple');
                                                ...
                                                <option value="1">' . __('Envío Programado', 'envialo-simple') . '</option>';
                                                                                            ...
                                                                                            <div id="estilo" class="postbox">
                                                                                                <h3 class="hndle" style="cursor:default"><span><?php _e('Diseño Campaña', 'envialo-simple') ?></span></h3>
                                                                                                <div class="inside">
                                                                                                    <a style="text-decoration:none"  class="abrir-modal-plantillas" id="seleccionar-plantilla-bt" href="#">
                                                                                                        <div class="button-secondary" style="margin: 15px;text-align:center;font-weight: bold">
                                                                                                            <?php _e('Seleccionar Plantilla', 'envialo-simple') ?>
                                                                                                        </div>
                                                                                                    </a>
                                                                                                </div>
                                                                                            </div>
                                                                                                    ...
                                                                                                    <div class="submitbox" id="submitpost">
                                                                                                        ...
                                                                                                        <div class="misc-pub-section" style="border:0">
                                                                                                            <div id="acordeon"style="width: 238px;">
                                                                                                                <h3 style="cursor: pointer!important" ><?php _e('Contenido de WordPress', 'envialo-simple') ?></h3>
