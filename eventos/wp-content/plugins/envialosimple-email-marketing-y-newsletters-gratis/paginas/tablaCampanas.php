    ...
    <?php else: ?>
        <?php if (empty($c['list']['item'])): ?>
            ...
            <?php else: ?>
                <div class='wp-caption'>
                    <p>
                        <?php _e('Aún No tienes Campañas Creadas.', 'envialo-simple'); ?></p>
                    <p>
                        <a style = "width:200px" href="<?php echo $adminUrl; ?>admin.php?page=envialo-simple-nuevo" id='abrir-modal-campana' class='button-primary abrir-modal-campana' >
                            <?php _e('Crear Nueva Campaña', 'envialo-simple'); ?>
                        </a>
                    </p>
                </div>
            <?php endif; ?>
                                    ...
                                    <div class='row-actions'>
                                        ...
                                        switch ($item['Status']):
                                            case 'Draft':
                                                ...
                                                <span class='edit'>
                                                    <a href='<?php echo "{$adminUrl}admin.php?page=envialo-simple&accion=campana-editar&idCampana={$item['CampaignID']}" ?>' title='Editá tu Campaña'>
                                                        <?php _e('Editar Campaña', 'envialo-simple'); ?>
                                                    </a> |
                                                </span>
                                                <?php break; ?>
                                            <?php case 'Paused': ?>
                                            ...
                                            <?php case 'Scheduled': ?>
                                                ...
                                                <span class='edit'>
                                                    <a href='' class='pausar-campana-bt' name='<?php echo $item['CampaignID'] ?>' title='<?php _e('Pausar Campaña', 'envialo-simple'); ?>' >
                                                        <?php _e('Pausar Camapña', 'envialo-simple'); ?>
                                                    </a> |
                                                </span>
                                                <?php break; ?>
                                            <?php case 'Stopped': ?>
                                            ...
                                            <?php case 'Sending': ?>
                                                <span class='edit'>
                                                    <a href='' class='pausar-campana-bt' name='<?php echo $item['CampaignID'] ?>' title='<?php _e('Pausar Campaña', 'envialo-simple'); ?>' >
                                                        <?php _e('Pausar Campaña', 'envialo-simple'); ?>
                                                    </a> |
                                                </span>
                                                <?php break; ?>
                                            <?php case 'Completed': ?>
                                ...
                                <td>
                                    ...
                                    switch ($item['Status']):
                                        ...
                                        <?php case 'Sending': ?>
                                            ...
                                            <?php break; ?>
                                        <?php case 'Completed': ?>
                                            <div class='icono-estado completada' title='<?php _e('Enviado', 'envialo-simple'); ?>'></div>
                                            <?php break; ?>
                                    <?php endswitch; ?>
                                </td>
