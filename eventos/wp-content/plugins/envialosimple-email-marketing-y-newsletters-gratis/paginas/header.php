<?php
//Modificado para nuevas versiones Wordpress - EnvialoSimple v3 por Pablo Mateoda 22/12/2015
...
<?php
    ...
    wp_localize_script('script', 'l10n',
        array(
            ...
            'bn' => __('Buscar Campaña.','envialo-simple'),
            ...
            'aEn1' => __('Antes de Editar una Campaña que se esta enviando, tiene que pausarlo','envialo-simple'),
            'aEn2' => __('Antes de Editar una Campaña programada para enviar, tiene que pausarlo','envialo-simple'),
            'rvc' => __('Por Favor revise todos los campos.','envialo-simple'),
            'egnfi' => __('Error al Guardar la campaña. La fecha de Programación es Incorrecta','envialo-simple'),
            'egne' => __('Error al Guardar la campaña. Error:','envialo-simple'),
            ...
            'angcn' => __('Aún no Generaste el Contenido de la Campaña.','envialo-simple'),
            'pfvtlc'=>__('Por Favor Verifica todos los Campos antes de Enviar tu Campaña.','envialo-simple'),
            'nseal' => __('La Campaña será Enviada a las Listas de Contactos seleccionadas. Está seguro que desea realizar esta operación?','envialo-simple'),
            'nels' => __('La campaña será Enviada a las Listas de Contactos seleccionadas, el día','envialo-simple'),
            'alas'=>__('a las','envialo-simple'),
            'conf1' => __('Está seguro que desa realizar esta operación?','envialo-simple'),
            'conf2' => __('Seguro que desea Pausar la Campaña?','envialo-simple'),
            'conf3' => __('Seguro que desea Reanudar la Campaña?','envialo-simple'),
            ...
            'tit2' => __('Previsualizar Campaña','envialo-simple'),
            'ok1' => __('Campaña Guardada Correctamente!','envialo-simple'),
            'bt1' => __('Programar Envío','envialo-simple'),
            'bt2' => __('Enviar Campaña!','envialo-simple')
            ));
...
<div id="header">
	...
	<?php if(isset($envios)): ?>
		<div id="envios">
		    <div><?php printf(__('Tienes <b>%d</b> Envíos Disponibles','envialo-simple'),$envios['credits']["availableCredits"]); if($envios['role'] == 'free'){_e(' para este mes.','envialo-simple');} ?></div>
				...
				<div id="modal-comprar-envios">
				    <?php if($envios['role'] == 'free'): ?>
				        <div class="actualizarCol fl">
                            ...
                            <ul>
                                <li><?php _e('Creación y gestión de múltiples cuentas de <em><strong>envialosimple</strong></em>','envialo-simple') ?></li>
                                ...
                                <li><?php _e('Sin referencia a <em><strong>envialosimple</strong></em> en los emails enviados','envialo-simple') ?></li>
    ...
    <div id="modalPrevisualizar">
        <div id="form-previsualizar-contenedor">
            <form id="form-previsualizar">
                ...
                <p>
                    <?php _e('Si desea Previsualizar su Campaña mediante Email, por favor Ingrese una dirección de Correo.','envialo-simple') ?>
                </p>
