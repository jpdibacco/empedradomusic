...
class Formularios extends Curl {
    ...
    function mostrarFormularios() {
        ...
        if (count($forms['list']['item']) > 0) {
            ...
            $html_noform = "<p>" . __('Aquí podrás Crear y Configurar formularios de suscripción donde luego, tus visitantes podrán suscribirse para recibir tus Campañas.', 'envialo-simple') . "</p>";
